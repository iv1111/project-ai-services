    ...
    if deployment_type == 'cuda':
        ...
        reranker_model_dict = {
            'rerank-bge-reranker-large': {
                ...
                'reranker_model': 'rerank-bge-reranker-large',
                'hosting_type': 'vllm'
            }
        }
    elif deployment_type == 'cpu':
        emb_model_dict = {
            'granite-embedding-278m-multilingual': {
                'emb_endpoint': "http://localhost:11434/v1/embeddings",
        ...
        llm_model_dict = {
            ...
            'granite-3.3-8b-instruct': {
                ...
                # 'llm_model': 'granite-3.3-8b-instruct-Q8_0'
                # "llm_model": "granite-3.3-8b-instruct-Q6_K:latest"
                # "llm_model": "granite-3.3-8b-instruct-Q5_K_M"
            }
        }
