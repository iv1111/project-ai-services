...
def rerank_helper(co2_client: ClientV2, query: str, document: Document, model: str) -> Tuple[Document, float]:
    """
...
if __name__ == "__main__":
    docs = [
        ...
        Document(page_content="Reranking helps in better search.", metadata={"source": "blog"}),
        Document(page_content="Milvus is a vector database.", metadata={"source": "tech"})
    ]
