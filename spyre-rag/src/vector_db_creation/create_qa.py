...
collection_name = generate_collection_name(emb_model, vlm_model, llm_model, DB_NAME_PREFIX)
records = fetch_all_entries('BWI_Docs_V1_4142bff4928f13415914eedf6627ca39')
