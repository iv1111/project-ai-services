...
def restore_data_to_milvus(collection_name, backup_file, host='localhost', port='19530', batch_size=1000):
    """
    ...
    for doc in backup_data:
        ...
        # For chunk_id, assuming it was part of the backup, otherwise generate a unique ID
...
# Example usage:
backup_file = "/root/henrik/spyre-rag/src/rag_on_power/BWI_Docs_V1_4142bff4928f13415914eedf6627ca39_backup.json"
collection_name = "BWI_Docs_V1_4142bff4928f13415914eedf6627ca39"
