...
def retrieve_documents(query, emb_model, emb_endpoint, max_tokens, vectorstore, top_k, deployment_type, mode="hybrid"):
    results = vectorstore.search(query, emb_model, emb_endpoint, max_tokens, top_k, deployment_type, mode=mode)
...
def search_and_answer_dual(
        ...
        top_k, top_r, stop_words, language, vectorstore, deployment_type
    ):
    ...
    retrieved_documents, scores = retrieve_documents(question, emb_model, emb_endpoint, max_tokens, vectorstore, top_k, deployment_type)
    print("retrieved")
